...
function Index() {
  ...
  return (
    <div className="border-2 w-full flex flex-col rounded-xl">
      <div className="flex items-center justify-between font-bold bg-gray-100 p-4">
        ...
        >
          ...
          >
            <ProgrammingArrow size={24} color="currentColor" />
    ...
    //     <div className='border-2 border-r-0 px-2 py-1 border-black rounded-lg rounded-r-none font-bold'>title</div>
    //     <button className='border-2 border-l border-r-0 px-2 py-1 border-black font-bold'>=</button>
    //     <div className='border-2 border-l border-r-0 px-2 py-1 border-black font-bold'>{(Object.keys(value)).length ? value?.toString() : "-"}</div>
    ...
    //         <Modal.Header>Mirror</Modal.Header>
    //         <Modal.Body className='p-6 flex flex-none overflow-hidden h-fit'>
    //             <div className=' w-full flex flex-col justify-center items-center gap-3'>
    //                 <div className='flex'>
    //                     <div className=' w-0.5 h-[10.3rem] bg-black mt-[3rem] '></div>
    //                     <div className='flex flex-col gap-3'>
    //                         <div>
    //                             <label htmlFor="Type" className="block ml-8 mb-2 text-sm font-medium text-gray-900 dark:text-white">Mirror Type</label>
    //                             <div className='flex items-center'>
    //                                 <div className=' h-0.5 w-8 bg-black ' />
    ...
    //                         </div>
    //                         <div>
    //                             <label htmlFor="Formula" className="block ml-8 mb-2 text-sm font-medium text-gray-900 dark:text-white">Formula</label>
    //                             <div className='flex items-center'>
    //                                 <div className=' h-0.5 w-8 bg-black ' />
    //                                 <input type="text" id="Formula" className="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" placeholder="John" required />
    //                             </div>

    //                         </div>
    //                         <div>
    //                             <label htmlFor="Target" className="block ml-8 mb-2 text-sm font-medium text-gray-900 dark:text-white">Mirror Target</label>
    //                             <div className='flex items-center'>
    //                                 <div className=' h-0.5 w-8 bg-black ' />
