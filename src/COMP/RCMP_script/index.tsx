...
function Index(dimention: Dimention) {
  ...
  return (
    <div className="border-2 w-full flex flex-col rounded-xl">
      <div className="flex items-center justify-between font-bold bg-gray-100 p-4">
        ...
        >
          ...
          >
            <DocumentCode2 size={24} color="currentColor" />
      ...
      <div className="p-4">
        ...
        >
          {dimention.optionList.map((option) => {
            return (
    ...
    //         <Modal.Header>Dropdown</Modal.Header>
    //         <Modal.Body className='p-6 flex flex-none overflow-hidden h-40'>
    //             <div className=' w-full flex flex-col justify-start items-start'>
    //                 <label htmlFor="countries" className="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Select an option</label>
    //                 <select id="countries" required={dimention.required} onChange={(e) => setValue(e.target.value)} className="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500">
