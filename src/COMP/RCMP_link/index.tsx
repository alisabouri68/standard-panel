...
function Index(dimention: Dimention) {
  const [packetID, setPacketID] = useState<any>("");
  ...
  // useEffect(() => {
  //     dimention.packetID = packetID;
  //     dimention.linkType = linkType;
  // }, [packetID, linkType])
  ...
  return (
    <div className="border-2 w-full flex flex-col rounded-xl">
      ...
      <div className="p-4">
        <div className=" w-full flex flex-col justify-center items-center gap-3">
          <div className="flex">
            <div className=" w-0.5 h-[3.4rem] bg-black mt-[1.3rem] "></div>
              ...
              <div>
                <div className="flex items-center">
                  ...
                  <input
                    ...
                    placeholder="Packet ID (all fields)"
    ...
    //     <div className='border-2 border-l border-r-0 px-2 py-1 border-black font-bold'>{packetID}</div>
    ...
    //             <div className=' w-full flex flex-col justify-center items-center gap-3'>
    //                 <div className='flex'>
    //                     <div className=' w-0.5 h-[5.2rem] bg-black mt-[3rem] '></div>
    //                     <div className='flex flex-col gap-3'>
    //                         <div>
    //                             <label htmlFor="Target" className="block ml-8 mb-2 text-sm font-medium text-gray-900 dark:text-white">Link Target</label>
    //                             <div className='flex items-center'>
    //                                 <div className=' h-0.5 w-8 bg-black ' />
    //                                 <input onChange={(e) => setPacketID(e.target.value)} value={packetID} type="text" id="Target" className="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" placeholder="John" required={dimention.required} autoFocus key={Math.random()} />
    //                             </div>
    //                         </div>
    //                         <div>
    //                             <label htmlFor="Type" className="block ml-8 mb-2 text-sm font-medium text-gray-900 dark:text-white">Link Type</label>
    //                             <div className='flex items-center'>
    //                                 <div className=' h-0.5 w-8 bg-black ' />
    //                                 <input onChange={(e) => setLinkType(e.target.value)} value={linkType} type="text" id="Type" className="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" placeholder="John" required={dimention.required} autoFocus key={Math.random()} />
    //                             </div>
