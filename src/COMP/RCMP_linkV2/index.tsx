    ...
    <div className="border-2 w-full flex flex-col rounded-xl">
      ...
      <div className="p-4">
        <input
          ...
          placeholder="Packer ID (all fields)"
          required={dimention.required}
        />
      </div>
    </div>
    // <div className='flex items-center justify-center w-fit shadow-lg'>
    //     <div className='border-2 border-r-0 px-2 py-1 border-black rounded-lg rounded-r-none font-bold'>{dimention.Meta.defVal}</div>
