...
const center = {
  lat: 35.80486677241937,
  lng: 51.36520385742188,
};

const iconPerson = new L.Icon({
  iconUrl: import("../../Asset/images/marker-icon.png") as any,
  iconRetinaUrl: import("../../Asset/images/marker-icon.png") as any,
...
function Index() {
  ...
  // useEffect(() => setAdress(dimention.defVal), [dimention.defVal]);

  // useEffect(() => { dimention.val = address }, [address])
  ...
  useEffect(() => {
    axios
      ...
      .then(({ data: { display_name } }) => setAdress(display_name))
      .catch();
  }, [position]);
  ...
  return (
    <div className="border-2 w-full flex flex-col rounded-xl">
      ...
      <div className="p-4">
        <div className=" h-600 relative">
          <div className=" absolute mb-6 top-4 z-[999] right-20 w-9/12 ">
    ...
    //         <div className='border-2 border-l border-r-0 px-2 py-1 border-black font-bold flex gap-3'>{address}</div>
